...
ALTER TYPE "public"."invite_code_status" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."normalize_friendship_order"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare a uuid; b uuid;
begin
  a := least(new.user_id, new.friend_id);
  b := greatest(new.user_id, new.friend_id);
  new.user_id := a;
  new.friend_id := b;
  return new;
end $$;
...
ALTER FUNCTION "public"."normalize_friendship_order"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."top_emojis_for_user"("target" "uuid", "limit_n" integer DEFAULT 3) RETURNS TABLE("emoji" "text", "uses" bigint)
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select emoji, uses
  from public.user_emoji_counts
...
ALTER FUNCTION "public"."top_emojis_for_user"("target" "uuid", "limit_n" integer) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."friendships" (
    ...
    CONSTRAINT "requester_is_member" CHECK ((("requested_by" = "user_a") OR ("requested_by" = "user_b")))
);
...
CREATE OR REPLACE VIEW "public"."friend_edges_v" AS
 SELECT "friendships"."user_a" AS "user_id",
    "friendships"."user_b" AS "friend_id"
   FROM "public"."friendships"
  WHERE ("friendships"."status" = 'accepted'::"public"."friend_status")
UNION ALL
 SELECT "friendships"."user_b" AS "user_id",
    "friendships"."user_a" AS "friend_id"
   FROM "public"."friendships"
  WHERE ("friendships"."status" = 'accepted'::"public"."friend_status");


ALTER VIEW "public"."friend_edges_v" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."friends_of_friends_v" AS
 WITH "edges" AS (
         SELECT "friend_edges_v"."user_id",
            "friend_edges_v"."friend_id"
           FROM "public"."friend_edges_v"
        ), "foaf" AS (
         SELECT "e1"."user_id",
            "e2"."friend_id" AS "foaf_id"
           FROM ("edges" "e1"
 ...
 SELECT DISTINCT "f"."user_id",
    "f"."foaf_id"
   FROM ("foaf" "f"
     LEFT JOIN "edges" "d" ON ((("d"."user_id" = "f"."user_id") AND ("d"."friend_id" = "f"."foaf_id"))))
  WHERE (("d"."user_id" IS NULL) AND ("f"."user_id" <> "f"."foaf_id"));


ALTER VIEW "public"."friends_of_friends_v" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."friends_of_friends_profiles_v" AS
 SELECT "f"."user_id",
    "p"."id",
    "p"."updated_at",
    "p"."full_name",
    ...
    "p"."hometown",
    "p"."birthday"
   FROM ("public"."friends_of_friends_v" "f"
     JOIN "public"."profiles" "p" ON (("p"."id" = "f"."foaf_id")));


ALTER VIEW "public"."friends_of_friends_profiles_v" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."invite_codes" (
    ...
    "redeemed_by_phone" character varying(20)
);
...
CREATE TABLE IF NOT EXISTS "public"."vibes" (
    ...
    CONSTRAINT "vibes_exactly_three_emojis" CHECK (("array_length"("emojis", 1) = 3)),
    CONSTRAINT "vibes_no_self_gifting" CHECK (("giver_id" <> "receiver_id"))
);
...
ALTER TABLE ONLY "public"."vibes"
    ADD CONSTRAINT "vibes_giver_receiver_unique" UNIQUE ("giver_id", "receiver_id");
...
CREATE UNIQUE INDEX "friendships_pair_uniq" ON "public"."friendships" USING "btree" (LEAST("user_a", "user_b"), GREATEST("user_a", "user_b"));



CREATE INDEX "idx_invite_codes_code" ON "public"."invite_codes" USING "btree" ("upper"(("code")::"text"));
...
CREATE INDEX "idx_invite_codes_inviter_id" ON "public"."invite_codes" USING "btree" ("inviter_id");



CREATE INDEX "idx_invite_codes_status" ON "public"."invite_codes" USING "btree" ("status");



CREATE INDEX "vibes_giver_created_idx" ON "public"."vibes" USING "btree" ("giver_id", "created_at" DESC);



CREATE INDEX "vibes_giver_id_idx" ON "public"."vibes" USING "btree" ("giver_id");



CREATE INDEX "vibes_receiver_created_idx" ON "public"."vibes" USING "btree" ("receiver_id", "created_at" DESC);



CREATE INDEX "vibes_receiver_id_idx" ON "public"."vibes" USING "btree" ("receiver_id");
...
CREATE OR REPLACE TRIGGER "vibes_set_updated_at" BEFORE UPDATE ON "public"."vibes" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
ALTER TABLE ONLY "public"."invite_codes"
    ADD CONSTRAINT "invite_codes_inviter_id_fkey" FOREIGN KEY ("inviter_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."vibes"
    ADD CONSTRAINT "vibes_giver_id_fkey" FOREIGN KEY ("giver_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."vibes"
    ADD CONSTRAINT "vibes_receiver_id_fkey" FOREIGN KEY ("receiver_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



CREATE POLICY "Enable insert for users based on user_id" ON "public"."friendships" FOR UPDATE USING ((("auth"."uid"() = "user_a") OR ("auth"."uid"() = "user_b"))) WITH CHECK ((("auth"."uid"() = "user_a") OR ("auth"."uid"() = "user_b")));



CREATE POLICY "Insert" ON "public"."friendships" FOR INSERT WITH CHECK ((("auth"."uid"() = "user_a") OR ("auth"."uid"() = "user_b")));
...
CREATE POLICY "Users can cancel own invite codes" ON "public"."invite_codes" FOR UPDATE USING ((("auth"."uid"() = "inviter_id") AND ("status" = 'active'::"public"."invite_code_status"))) WITH CHECK ((("auth"."uid"() = "inviter_id") AND ("status" = 'cancelled'::"public"."invite_code_status")));



CREATE POLICY "Users can create invite codes" ON "public"."invite_codes" FOR INSERT WITH CHECK (("auth"."uid"() = "inviter_id"));
...
CREATE POLICY "Users can view own invite codes" ON "public"."invite_codes" FOR SELECT USING (("auth"."uid"() = "inviter_id"));
...
CREATE POLICY "select" ON "public"."friendships" FOR SELECT USING ((("auth"."uid"() = "user_a") OR ("auth"."uid"() = "user_b")));
...
CREATE POLICY "vibes_delete_as_giver" ON "public"."vibes" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "giver_id"));



CREATE POLICY "vibes_insert_as_self" ON "public"."vibes" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "giver_id"));



CREATE POLICY "vibes_read_public" ON "public"."vibes" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "vibes_update_as_giver" ON "public"."vibes" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "giver_id")) WITH CHECK (("auth"."uid"() = "giver_id"));
...
GRANT ALL ON FUNCTION "public"."normalize_friendship_order"() TO "anon";
GRANT ALL ON FUNCTION "public"."normalize_friendship_order"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."normalize_friendship_order"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."top_emojis_for_user"("target" "uuid", "limit_n" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."top_emojis_for_user"("target" "uuid", "limit_n" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."top_emojis_for_user"("target" "uuid", "limit_n" integer) TO "service_role";
...
GRANT ALL ON TABLE "public"."friend_edges_v" TO "anon";
GRANT ALL ON TABLE "public"."friend_edges_v" TO "authenticated";
GRANT ALL ON TABLE "public"."friend_edges_v" TO "service_role";



GRANT ALL ON TABLE "public"."friends_of_friends_v" TO "anon";
GRANT ALL ON TABLE "public"."friends_of_friends_v" TO "authenticated";
GRANT ALL ON TABLE "public"."friends_of_friends_v" TO "service_role";
...
GRANT ALL ON TABLE "public"."friends_of_friends_profiles_v" TO "anon";
GRANT ALL ON TABLE "public"."friends_of_friends_profiles_v" TO "authenticated";
GRANT ALL ON TABLE "public"."friends_of_friends_profiles_v" TO "service_role";
...
GRANT ALL ON TABLE "public"."vibes" TO "anon";
GRANT ALL ON TABLE "public"."vibes" TO "authenticated";
GRANT ALL ON TABLE "public"."vibes" TO "service_role";
