-- Fix ambiguous column reference in get_message_channels RPC function
-- Bug: Line 57 had unqualified "user_id" and "friend_id" which could refer to either
-- conversation_reads columns or the outer context af.friend_id
-- Fix: Added table alias 'cr' and qualified both columns
...
COMMENT ON FUNCTION get_message_channels(UUID) IS
  'Returns message channels with unread counts. Fixed ambiguous friend_id reference in conversation_reads subquery (2026-01-03).';
