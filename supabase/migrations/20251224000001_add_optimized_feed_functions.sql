-- Create optimized function to get feed posts with aggregated counts
-- This replaces multiple queries with a single optimized query
...
-- Create optimized function to get user posts with aggregated counts
